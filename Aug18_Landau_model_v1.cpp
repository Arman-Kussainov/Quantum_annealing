...
int main(){
	...
	//int flag=1;
	double r_atio=0.1;
	double J=-1.5,E1t,E2t;
	int m=16, n=16;
	int total_steps=9000000;
	...
	while(c_ount<=total_steps){c_ount++;
		for (int ii=0;ii<m*n;ii++){ // we assume that we should randomly access pretty much all spins in the array
			...
			// This part of index definition works only for simpliest Ising modell with qq=2
